...
func TestHealthEndpoint(t *testing.T) {
	...
	ticketHandler := handlers.NewTicketHandler(nil, userService)

	router := SetupRouter(mockDB, userHandler, authHandler, authMiddleware, exerciseHandler, healthHandler, ticketHandler)
