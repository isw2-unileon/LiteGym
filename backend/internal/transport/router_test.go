...
func (m *MockProfileRepository) GetStats(ctx context.Context, userID string) (*model.ProfileStats, error) {
...
func TestHealthEndpoint(t *testing.T) {
	...
	router := SetupRouter(mockDB, userHandler, authHandler, authMiddleware, exerciseHandler, newTestOverviewHandler(), healthHandler, newTestTicketHandler(userService), workoutHandler, newTestProfileHandler())
